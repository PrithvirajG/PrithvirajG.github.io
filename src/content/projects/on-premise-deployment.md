---
title: Taking the whole platform offline for air-gapped customers
employer: flytbase
status: production
disciplines: [infrastructure, robotics]
...
enterprise customers operating in air-gapped or hybrid network environments
where no internet access is permitted. Worked across the full stack, from the
FlytAIR Edge Device (ROS2-based) to Kubernetes-managed application deployment,
to make the entire platform self-contained and deployable offline.
